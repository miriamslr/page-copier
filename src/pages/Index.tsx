  ...
  return <div className="min-h-screen flex items-center">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex justify-end mb-6 sm:mb-8">
          <Button onClick={() => navigate(isAuthenticated ? "/dashboard" : "/auth")} variant="ghost" size="sm" className="text-muted-foreground hover:text-foreground backdrop-blur-sm">
        ...
        <div className="max-w-2xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="text-center space-y-3 sm:space-y-4">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground px-4">
              Clone qualquer página de vendas em segundos.
            </h1>
